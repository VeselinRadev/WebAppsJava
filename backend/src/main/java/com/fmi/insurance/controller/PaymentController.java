...
public class PaymentController {
    ...
    @GetMapping
    public ResponseEntity<List<PaymentResponseDto>> getPayments(PaymentSearchParamDto searchParams) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<PaymentResponseDto> updatePayment(@PathVariable Long id, @RequestBody PaymentPatchDto patch) {
